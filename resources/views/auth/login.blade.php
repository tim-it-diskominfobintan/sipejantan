                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <div class="py-3 py-md-0 px-3 px-md-0">
                                    <h1 class="h1 text-start p-0 m-0 fw-bolder">Login</h1>
                                    <p class="text-muted fw-light p-0 mb-4">untuk mengakses aplikasi ini.</p>
                                </div>
                                ...
                                <form id="form-login" method="POST" action="{{ route('login') }}" autocomplete="off"
                                    ...
                                    <div class="mb-2">
                                        <label class="form-check">
                                            ...
                                            <span class="form-check-label">Selalu login pada perangkat ini</span>
                                        </label>
                                    </div>
