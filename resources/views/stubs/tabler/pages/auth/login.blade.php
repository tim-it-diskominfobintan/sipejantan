                    ...
                    <div class="container-tight">
                        <div class="text-center mb-4">
                            <!-- BEGIN NAVBAR LOGO --><a href="." aria-label="Tabler"
                                class="navbar-brand navbar-brand-autodark"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-lg d-none d-lg-block">
                    <svg class="img d-block mx-auto" xmlns="http://www.w3.org/2000/svg" height="400"
                        ...
                        <path
                            ...
                            fill="#F7F8FC" class="tblr-illustrations-boy-with-key-a"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="#232B41" class="tblr-illustrations-boy-with-key-b"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="white" class="tblr-illustrations-boy-with-key-c"></path>
                        <path
