                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 mb-3">
                                            <div class="form-group">
                                                <label for="update-kode_asset" class="form-label fw-semibold"><i
                                                        class="bi bi-key text-primary me-2"></i>Kode Asset *</label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="bi bi-key"></i></span>
                                                    <input type="text" id="update-kode_asset" name="kode_asset"
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="update-nama_asset" class="form-label fw-semibold"><i
                                        ...
                                        <div class="col-md-2 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="jenis_asset_id" class="form-label fw-semibold"><i
                                                        class="bi bi-archive text-primary me-2"></i>Jenis
                                                    Asset *</label>
                                                <select class="form-select" id="update-jenis_asset_id"
                                                    name="jenis_asset_id">
                                        ...
                                        <div class="col-md-2 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="penanggung_jawab_id" class="form-label fw-semibold"><i
                                                        class="bi bi-person text-primary me-2"></i>Penanggung
                                                    Jawab *</label>
                                                <select class="form-select" id="update-penanggung_jawab_id"
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="jalan_id" class="form-label fw-semibold"><i
                                                        class="bi bi-signpost-fill text-primary me-2"></i>Lokasi
                                                    Jalan *</label>
                                                <select class="form-select" id="update-jalan_id" name="jalan_id">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="kondisi"
                                                    class="form-label 
                                                fw-semibold"><i
                                                        class="bi bi-bookmark-check text-primary me-2"></i>Kondisi *</label>
                                                <select class="form-select" id="update-kondisi" name="kondisi">
                                                ...
                                                <div id="update-kondisi-msg"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="kecamatan_id" class="form-label fw-semibold"><i
                                                        class="bi bi-building text-primary me-2"></i>Kecamatan *</label>
                                                <select class="form-select select2" id="update-kecamatan_id"
                                                    name="kecamatan_id">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group mb-3">
                                                <label for="kelurahan_id" class="form-label fw-semibold"><i
                                                        class="bi bi-building text-primary me-2"></i>Kelurahan *</label>
                                                <select class="form-select" id="update-kelurahan_id" name="kelurahan_id"
                                                    disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                <label for="koordinat" class="form-label fw-semibold"><i
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="update-koordinat"
                                                        name="koordinat" value="{{ $asset->koordinat }}">
                                                ...
                                                <div class="form-text">Format: latitude, longitude (pisahkan dengan koma)
                                                    ...
                                                    *
                                                    <span id="status-message" class="form-text"
                                                        ...
                                                        tombol
                                                        deteksi
                                                        lokasi untuk mendapatkan koordinat Anda</span>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-section">
                                                <div class="form-group mb-3">
                                                    <label for="update-foto_asset" class="form-label fw-semibold"><i
                                                            class="bi bi-image text-primary me-2"></i>
                                                        Upload Foto Asset * (Maks ukuran file
                                                        2MB)</small></span>
                                                    </label>
                                                    <!-- tambahkan multiple -->
                                                    <input type="file" id="update-foto_asset" name="foto_asset[]"
                                                        class="form-control" accept="image/*" multiple>
                                                    <div id="update-foto_asset-msg"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('script')
    <script>
        ...
        let kelurahanId = "{{ $asset->kelurahan_id }}";
        if (kecamatanId) {
        ...
        const fileInput = document.getElementById('update-foto_asset');
