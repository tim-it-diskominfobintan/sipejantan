...
@section('action-header')
    ...
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            ...
            <a href="{{ url('admin/master/kecamatan/export') }}" class="btn btn-success" target="_blank">
...
@section('content')
    ...
    @include('admin.master.kecamatan.modal')
@endsection
...
@push('script')
    <script>
        ...
        $('#form-update').submit(function(e) {
            ...
            callApi(formData, `{{ url()->current() }}/${$('#update-id_kecamatan').val()}`)
        })
        ...
        $('#table tbody').on('click', '.btn-update', function() {
            ...
            $(`#update-id_kecamatan`).val(detail.id_kecamatan)
        })
