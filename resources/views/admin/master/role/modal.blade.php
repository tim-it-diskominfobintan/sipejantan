                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="create-guard_name" name="guard_name" class="form-control" placeholder="Masukkan guard" value="web">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="create-description" name="description" class="form-control" placeholder="Masukkan deskripsi">
                                <div id="create-description-msg"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="create-permission_ids" class="form-label">Permissions</label>
                                <select name="permission_ids[]" id="create-permission_ids" class="form-select" multiple="multiple">
                                    <option value="" disabled>Pilih</option>
                                    @foreach ($permissions as $permission)
                                        <option value="{{ $permission->id }}">{{ $permission->name }}</option>
                                    @endforeach
                                </select>
                                <div id="create-permission_ids-msg"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="update-guard_name" name="guard_name" class="form-control" placeholder="Masukkan guard" value="web">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="update-description" name="description" class="form-control" placeholder="Masukkan deskripsi">
                                <div id="update-description-msg"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="update-permission_ids" class="form-label">Permissions</label>
                                <select name="permission_ids[]" id="update-permission_ids" class="form-select" multiple="multiple">
                                    <option value="" disabled>Pilih</option>
                                    @foreach ($permissions as $permission)
                                        <option value="{{ $permission->id }}">{{ $permission->name }}</option>
                                    @endforeach
                                </select>
                                <div id="update-permission_ids-msg"></div>
                            </div>
                        </div>
                    </div>
                </div>
