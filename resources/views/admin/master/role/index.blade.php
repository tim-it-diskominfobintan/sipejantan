...
@push('script')
    <script>
        ...
        initializeSelect2('#create-permission_ids', '#form-create')
        initializeSelect2('#update-permission_ids', '#form-update')
        ...
        $('#table tbody').on('click', '.btn-update', function() {
            ...
            $(`#update-permission_ids`).val(permissionIds).trigger('change')
