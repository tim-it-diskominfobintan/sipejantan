...
@section('content')
    ...
    @include('admin.master.penanggung_jawab.modal')
@endsection
    ...
    <script>
        ...
        const table = $('#table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'warna_penanggung_jawab',
                    name: 'warna_penanggung_jawab',
                    render: function(data, type, row, meta) {
                        return `<div style="width: 40px; height: 20px; background-color: ${data}; border: 1px solid #ccc;"></div>`;
                    }
                },
                {
                    data: 'actions',
        ...
        $('#form-update').submit(function(e) {
            ...
            callApi(formData, `{{ url()->current() }}/${$('#update-id_penanggung_jawab').val()}`)
        })
        ...
        $('#table tbody').on('click', '.btn-update', function() {
            ...
            $(`#update-id_penanggung_jawab`).val(detail.id_penanggung_jawab)
        })
