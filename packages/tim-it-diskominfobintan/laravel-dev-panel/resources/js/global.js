...
function dateTimeShortMonthIndo(isoDateStr) {
    ...
    const tgl = date.getUTCDate().toString().padStart(2, '0');
    const bln = bulan[date.getUTCMonth()];
    const thn = date.getUTCFullYear();
    const jam = date.getUTCHours().toString().padStart(2, '0');
    const menit = date.getUTCMinutes().toString().padStart(2, '0');
    const detik = date.getUTCSeconds().toString().padStart(2, '0');
