...
class JsonResponseHelper
{
    ...
    public static $FAILED_INFO = "Info Penting.";
    ...
    public static function successWithAdditional($data = null, $additionals, $message = 'Success', $code = 200, $headers = [])
    {
        $response = [
            'status' => 'success',
            'success' => true,
    ...
    public static function info($error = null, $message = 'Informasi Penting', $code = 200, $headers = [])
    {
        $response = [
            'success' => true,
            'status' => 'info',
